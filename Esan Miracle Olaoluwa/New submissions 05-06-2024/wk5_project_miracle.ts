...
playlist.addSong(new Song("Song A", "Artist A", 300));
playlist.addSong(new Song("Song B", "Artist B", 250));
playlist.addSong(new Song("Song C", "Artist C", 200));
...
console.log("\nSearching for 'Song B':");
const foundSong = playlist.searchSong("Song B");
if (foundSong) {
