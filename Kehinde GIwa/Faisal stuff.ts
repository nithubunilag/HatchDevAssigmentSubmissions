type updatables = 'keyboard' | 'nic' | `display` |'hardDisk' | 'os'
type canBeupdatedTo = OS | Keyboard | Display | NetworkInterfaceCard | HardDisk;
...
class Laptop{
    ...
    update(thingToUpdate: updatables, newValue:canBeupdatedTo){
        let error: string = "";
